...
export const page = () => {
  return <div>Política de Privacidad de Meethustle.io

  Última actualización: 21/02/20124
  
  Meethustle.io (`nosotros``, `nuestro`` o `nuestros``) opera el sitio web Meethustle.io (el `Servicio``).
  ...
  No utilizaremos ni compartiremos su información con nadie, excepto como se describe en esta Política de Privacidad.
  ...
  Datos personales
  Mientras utiliza nuestro Servicio, es posible que le solicitemos que nos proporcione cierta información personalmente identificable que puede incluir, entre otros, su nombre, dirección de correo electrónico y número de teléfono. Los datos personales (`Datos``) pueden ser utilizados para contactarlo o identificarlo.
  ...
  Meethustle.io utiliza los datos recopilados para diversos fines:
  ...
  Si usted se encuentra fuera de Argentina y elige proporcionarnos información, tenga en cuenta que transferimos los datos, incluidos los Datos personales, a Argentina y que los procesamos allí.
  ...
  Meethustle.io tomará todas las medidas razonablemente necesarias para garantizar que sus datos sean tratados de forma segura y de conformidad con esta Política de Privacidad y no se realizará ninguna transferencia de sus Datos personales a una organización o país a menos que existan controles adecuados, incluida la seguridad de sus datos y otra información personal.
  
  Divulgación de datos
  
  Requisitos legales
  
  Meethustle.io puede divulgar sus Datos personales de buena fe cuando considere que esta acción es necesaria para:
  
  Cumplir con una obligación legal
  Proteger y defender los derechos o la propiedad de Meethustle.io
  ...
  Nuestro Servicio no está dirigido a personas menores de 18 años (`Menores`).
  
  No recopilamos a sabiendas información personalmente identificable de menores de 18 años. Si usted es padre/madre o tutor y sabe que su hijo nos ha proporcionado Datos personales, comuníquese con nosotros. Si nos enteramos de que hemos recopilado Datos personales de menores sin verificación del consentimiento parental, tomamos medidas para eliminar esa información de nuestros servidores.
  ...
  Por correo electrónico: joseandrescolmenares02@gmail.com</div>;
};
